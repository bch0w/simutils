...
# output parameters
PATH_INPUT="/import/c1/ERTHQUAK/bhchow/work/seisflows/NALASKA_INVERSION/output"
PATH_OUT="NAKINV"
MODEL_OUTPUT="NAKINV/MODELS/"
GRADIENT_OUTPUT="NAKINV/GRADIENTS/"
...
for MODEL in ${PATH_INPUT}/MODEL_*
do
...
for GRADIENT in ${PATH_INPUT}/GRADIENT_*
do
    # Remove all symlinked data in preparation for next
    cd ${INPUT_FILE_DIR}
