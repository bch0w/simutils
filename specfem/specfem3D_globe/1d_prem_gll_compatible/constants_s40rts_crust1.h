...
! Topography defaults to ETOPO4
  integer, parameter :: EARTH_NX_BATHY = NX_BATHY_1
  integer, parameter :: EARTH_NY_BATHY = NY_BATHY_1
  double precision, parameter :: EARTH_RESOLUTION_TOPO_FILE = RESOLUTION_TOPO_FILE_1
  character (len=*), parameter :: EARTH_PATHNAME_TOPO_FILE = PATHNAME_TOPO_FILE_1
...
!  simulation will start at t = - t0)
  double precision, parameter :: USER_T0 = 100.0d0
...
! BC Changed S362ANI -> S40RTS
  integer, parameter :: GLL_REFERENCE_1D_MODEL = REFERENCE_MODEL_1DREF
  integer, parameter :: GLL_REFERENCE_MODEL = THREE_D_MODEL_S40RTS
