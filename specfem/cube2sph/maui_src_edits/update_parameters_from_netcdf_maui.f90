subroutine update_parameters_from_netcdf(x, y, z, rho, vp, vs, rho_new, vp_new, vs_new, &
  ...
  character(len = *), parameter :: model_fn = '/home/chowbr/cube2sph/nzatom/nz-atom-north-chow-etal-2021-vp+vs-shallow.r0.0-n4.nc' !!! bchow
  ...
  call inquire_dimension_netcdf_model(ncid,'x',dimid,nlon)  !!! bchow
  call inquire_variable_netcdf_model(ncid,'x',1,var_num,dimids_temp)  !!! bchow
  ...
  call inquire_dimension_netcdf_model(ncid,'y',dimid,nlat)  !!! bchow
  call inquire_variable_netcdf_model(ncid,'y',1,var_num,dimids_temp)  !!! bchow
  ...
  ! get vs dataset
  call inquire_variable_netcdf_model(ncid, 'vs', 4, var_num, dimids_3d)  !!! bchow vs is 4th column in my model
