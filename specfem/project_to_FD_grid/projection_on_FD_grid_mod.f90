...
!--------------------------------------------------------------------------------------------------------------------
  ...
  subroutine compute_interpolation_coeff_FD_SEM(projection_fd, myrank)
    ...
    integer                                                :: ispec_selected, ispec, iglob, islice_selected
    double precision                                       :: xi_loc, eta_loc, gamma_loc, distance_from_target
...
!!$ !!$       if (DEBUG_MODE) write(IIDD,*) isepc, NSPEC_AB
    ...
    if (DEBUG_MODE) write(IIDD,*) ' START  compute_interpolation_coeff_FD_SEM step 2'
